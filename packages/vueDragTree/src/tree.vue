<template>
  ...
  >
    ...
    <div class="el-tree-node__empty-block" v-if="isEmpty">
...
<script>
  ...
  import { addClass, removeClass } from '../model/util';
  export default {
    name: 'ElTree',
    ...
    created() {
      ...
      this.$on('tree-node-drag-over', (event, treeNode) => {
        ...
        const iconPosition = dropNode.$el.querySelector('.org-tree-node-label').getBoundingClientRect();
